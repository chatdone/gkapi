...
export async function seed(knex: Knex): Promise<void> {
  ...
  await knex('package_prices').insert([
    {
      package_id: 25,
      stripe_price_id: 'price_1KKIMnIElsOvFh8G4sQvHOwq',
      name: 'Monthly',
      price: 129,
      interval: 'month',
      interval_count: 1,
    ...
    {
      package_id: 25,
      stripe_price_id: 'price_1KKIMnIElsOvFh8GAbzW40DE',
      name: 'Yearly',
      price: 1238.4,
      interval: 'year',
      interval_count: 1,
    ...
    {
      package_id: 26,
      stripe_price_id: 'price_1KKIPgIElsOvFh8GJR2t1Z8p',
      name: 'Monthly',
      price: 249,
      interval: 'month',
      interval_count: 1,
    ...
    {
      package_id: 26,
      stripe_price_id: 'price_1KKIPgIElsOvFh8GV6qypJHm',
      name: 'Yearly',
      price: 2390.4,
      interval: 'year',
      interval_count: 1,
    ...
    {
      package_id: 27,
      stripe_price_id: 'price_1KKIQTIElsOvFh8GlMN9WjzY',
      name: 'Monthly',
      price: 369,
      interval: 'month',
      interval_count: 1,
    ...
    {
      package_id: 27,
      stripe_price_id: 'price_1KKIQUIElsOvFh8GDuv8BHkv',
      name: 'Yearly',
      price: 3242.4,
      interval: 'year',
      interval_count: 1,
    ...
    {
      package_id: 28,
      stripe_price_id: 'price_1KKIVWIElsOvFh8G0dKQtpA4',
      name: 'Monthly',
      price: 3,
      interval: 'month',
      interval_count: 1,
    ...
    {
      package_id: 28,
      stripe_price_id: 'price_1KKIVWIElsOvFh8G1wLTTLSR',
      name: 'Yearly',
      price: 28.8,
      interval: 'year',
      interval_count: 1,
